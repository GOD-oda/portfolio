  ...
  $('.contact-form').on('submit', function (event) {
    ...
    setTimeout(function () {
      $.ajax({
        ...
        if ('name' in response_json && response_json.name.length > 0) {
          // invalid name
          var input_name = form.find('.input-name');
        ...
        if ('email' in response_json && response_json.email.length > 0) {
          // invalid email
          var input_email = form.find('.input-email');
        ...
        if ('subject' in response_json && response_json.subject.length > 0) {
          // invalid subject
          var input_subject = form.find('.input-subject');
        ...
        if ('body' in response_json && response_json.body.length > 0) {
          // invalid body
          var input_body = form.find('.input-body');
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(22), __webpack_require__(45)(module)))
